<template>
  <div class="flex gap-12 items-center" v-if="isVisible">
    <div class="flex w-full bg-white group relative my-4 min-h-[200px] cursor-pointer" ref="button">
      <div v-if="props.option.image" class="w-full">
        <img class="h-full object-cover w-full" :src="props.option.image" width="200" height="200" :alt="props.option.key"/>
      </div>
