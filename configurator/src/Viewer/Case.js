...
export default class Case extends Object3D {
  ...
  async init () {
    await super.init()
    super.setMaterial(this.config.material || { color: '#FFFFFF', opacity: 1 }, false) // Aggiungo il ricevuto tramite opzioni oppure gli aggiungo un colore nero di default
  }
